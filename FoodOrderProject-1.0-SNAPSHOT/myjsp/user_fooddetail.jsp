                ...
                <div class="food-section">
                    <div class="food-img-box">
                        <img src="<%=request.getContextPath()%>/showfoodimg?foodid=<%= rs.getString("FoodItem_UniqueID")%>&restid=<%= rs.getString("Resturant_UniqueID")%>"
                             alt="Food Image"></div>
                    <div>
                        <input type="hidden" name="foodid" value="<%= rs.getString("FoodItem_UniqueID")%>">
                        <input type="hidden" name="restid" value="<%= rs.getString("Resturant_UniqueID")%>">
                        ...
                        <%
                            ...
                            String q3 = "SELECT SUM(fi.calories_kcal) AS totalCalories, "
                                    ...
                                    + "FROM foodingredientdetail fi inner join foodresturantdetail fr on"
                                    + " fr.FoodResturant_UniqueID = fi.FoodResturant_UniqueID WHERE "
                                    + "fr.Fooditem_UniqueID=? and Resturant_UniqueID=?";
                ...
                <table>
                    ...
                    <%
                        String q4 = "SELECT i.Ingredient_Name, fi.unit, fi.Quantity, "
                                ...
                                + "ON i.Ingredient_UniqueID = fi.Ingredient_UniqueID inner join "
                                + "foodresturantdetail fr on fr.FoodResturant_UniqueID = fi.FoodResturant_UniqueID "
                                + "WHERE fr.FoodItem_UniqueID = ? and fr.Resturant_UniqueID=?";
